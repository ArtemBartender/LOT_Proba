const cocktails = [
  ...
  { name: { pl: "Caribbean Sunset", en: "Caribbean Sunset" }, ingredients: { pl: ["Rum", "Passion Fruit Syrup", "Nektar ananasowy"], en: ["Rum", "Passion Fruit Syrup", "Pineapple nectar"] }, category: "rum" },
  ...
  { name: { pl: "Irishman", en: "Irishman" }, ingredients: { pl: ["Irish Cream", "Syrop waniliowy", "Mleko lub śmietanka"], en: ["Irish Cream", "Vanilla syrup", "Milk or cream"] }, category: "liqueur" },
  ...
  { name: { pl: "Irishman", en: "Irishman" }, ingredients: { pl: ["Carolans Irish Cream", "Bushmills Original"], en: ["Carolans Irish Cream", "Bushmills Original"] }, category: "liqueur" },
  { name: { pl: "Gold Rush", en: "Gold Rush" }, ingredients: { pl: ["Bushmills Original", "Krupnik", "Sok z cytryny"], en: ["Bushmills Original", "Krupnik", "Lemon juice"] }, category: "whiskey" },
  { name: { pl: "The Curious Jackalope", en: "The Curious Jackalope" }, ingredients: { pl: ["Gunpowder Irish Gin", "Sok z limonki", "Sok grejpfrutowy", "Syrop cukrowy"], en: ["Gunpowder Irish Gin", "Lime juice", "Grapefruit juice", "Simple syrup"] }, category: "gin" },
  { name: { pl: "Old Fashioned", en: "Old Fashioned" }, ingredients: { pl: ["Old Fashioned Bourbon", "Syrop cukrowy", "Angostura bitters"], en: ["Old Virginia Bourbon", "Simple syrup", "Angostura bitters"] }, category: "whiskey" },
  { name: { pl: "Old Virginia Manhattan", en: "Old Virginia Manhattan" }, ingredients: { pl: ["Old Virginia Bourbon", "Martini Bianco", "Angostura bitters"], en: ["Old Virginia Bourbon", "Martini Bianco", "Angostura bitters"] }, category: "whiskey" }
];
